        ...
        <div className="mx-auto grid max-w-[1350px] gap-12 lg:grid-cols-[.82fr_1.18fr] lg:items-start">
          ...
          <div className="lg:pl-6">
            ...
            <div className="mt-8 grid gap-3 sm:grid-cols-3">
              ...
              <div className="rounded-2xl border border-white/10 bg-white/[0.025] p-4"><Globe2 size={17} className="text-[#0529ED]"/><div className="mt-3 text-[10px] font-black uppercase tracking-[0.12em]">ENGLISH / ESPAÑOL</div></div>
